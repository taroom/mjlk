...
<body>
	...
	<h3 align="center">STOK Gudang <?= $gudang ?> - <?= date('d/F/Y') ?></h3>
<center>
<table border="0" cellspacing="1" cellpadding="0">
  <?php
  $sql="SELECT * FROM stok s LEFT JOIN barang b ON s.barang_id = b.barang_id WHERE s.id_gudang = '$gudang' ORDER BY s.barang_id ASC";	
  $sqlsum ="SELECT SUM(qty) As summ FROM stok WHERE id_gudang = '$gudang'";	
  ?>
  <tr>
