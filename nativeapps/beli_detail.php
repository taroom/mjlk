...
<table cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td id="noBorder">Tipe Transaski</td>
    <td id="noBorder">:</td>
    <td id="noBorder"><?php echo "$data[tipe_transaksi]"; ?></td>
  </tr>
  <tr>
    <td id="noBorder">Tgl Transaksi</td>
    <td id="noBorder">:</td>
    <td id="noBorder"><?php echo date('d-m-Y', strtotime($data['tgl_trans'])); ?></td>
  </tr>
  <tr>
