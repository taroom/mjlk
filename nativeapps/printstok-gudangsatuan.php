...
require_once "library/fungsi_standar.php";
  ...
  $gudang = $_GET['pilih_gudang'];//dapat dari abprint.php
...
<body>
	...
	<h3 align="center">STOK Gudang <?= $gudang ?> Dengan Satuan <?= $satuan ?> - <?= date('d/F/Y') ?></h3>
<center>
<table border="0" cellspacing="1" cellpadding="0">
  <?php
  $sql="SELECT * FROM stok s LEFT JOIN barang b ON s.barang_id = b.barang_id WHERE s.id_gudang = '$gudang' AND s.satuan = '$satuan' ORDER BY s.barang_id ASC";	
  $sqlsum ="SELECT SUM(qty) As summ FROM stok WHERE id_gudang = '$gudang' AND satuan = '$satuan'";	
  ?>
  <tr>
